...
INSERT INTO TITLE VALUES ('Anime',1,1,'C:\\Collection\Animes\Naruto');
...
INSERT INTO TITLE VALUES ('Anime',2,2,'C:\\Collection\Animes\One Piece');
UPDATE TITLE_DETAILS
SET title_id= 2
WHERE id = 2;
...
INSERT INTO TITLE VALUES ('Anime',3,3,'C:\\Collection\Animes\Dragon Ball');
UPDATE TITLE_DETAILS
SET title_id= 3
WHERE id = 3;
...
INSERT INTO TITLE VALUES ('Anime',4,4,'C:\\Collection\Animes\Fairy Tail');
UPDATE TITLE_DETAILS
SET title_id= 4
WHERE id = 4;
...
INSERT INTO TITLE VALUES ('Manga',5,5,'C:\\Collection\Mangas\Vagabond');
UPDATE TITLE_DETAILS
SET title_id= 5
WHERE id = 5;
...
INSERT INTO ITEM (dtype, id, path, description, duration, anime_id,item_details_id) values ('EPISODE',1,'C:\\Collection\Animes\\Naruto\\Naruto - Episode 01.mp4','The begin, naruto is a ninja', '23.30', 1,1);
UPDATE ITEM_DETAILS
SET item_id= 1
WHERE id = 1;
...
INSERT INTO ITEM (dtype, id, path, description, duration, anime_id,item_details_id) values ('EPISODE',2,'C:\\Collection\Animes\\One Piece\\One Piece - Episode 01.mp4','The begin, luffy is a pirate', '23.30', 2,2);
UPDATE ITEM_DETAILS
SET item_id= 2
WHERE id = 2;
...
INSERT INTO ITEM (dtype, id, path, description, duration, anime_id,item_details_id) values ('EPISODE',3,'C:\\Collection\Animes\\Dragon Ball\\Dragon Ball - Episode 01.mp4','The begin, goku is a sayajin', '23.30', 3,3);
UPDATE ITEM_DETAILS
SET item_id= 3
WHERE id = 3;
...
INSERT INTO ITEM (dtype, id, path, description, duration, anime_id,item_details_id) values ('EPISODE',4,'C:\\Collection\Animes\\Dragon Ball\\Dragon Ball - Episode 01.mp4','The begin, goku is a sayajin', '23.30', 4,4);
UPDATE ITEM_DETAILS
SET item_id= 4
WHERE id = 4;
